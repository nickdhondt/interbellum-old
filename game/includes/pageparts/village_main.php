...
<p>
    ...
    Maximum level: Level <?php echo $max_level ?>
</p>
<h2>Productiestatistieken</h2>
<p>
    productie op <em>huidige</em> level :  <?php echo round($current_resources_per_hour)." ".$resource ?><br />
    <?php if ($maxed_out === false) { ?>
    productie op <em>volgende</em> level :  <?php echo round($next_level_resources_per_hour)." ".$resource ?>
</p>
 <?php } ?>
<?php if ($maxed_out === false) { ?>
