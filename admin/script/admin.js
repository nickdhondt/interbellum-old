...
// Initiate the script when the page has bee loaded
...
aek = {
    ...
    generateKeys: function() {
        ...
        xhr.sendRequest("post", "data=" + JSON.stringify(data), "../server/register/generate_keys.php", aek.interpretGenerateKeys);
