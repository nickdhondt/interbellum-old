...
<main>
    <div class="accent_region" id="about">
        <div>
            <h1>Interbellum <small>(Working title)</small></h1>
            <div><strong>Version:</strong> 1.99.10 pre-alpha</div>
            <div><strong>Last update:</strong> 03/08/2015</div>
            <div id="about_changes">
                <strong>Changes:</strong>
                <ul>
                    <li>Opening and closing conversations</li>
                    <li>Better mobile support</li>
                    <li>Action icons added</li>
                </ul>
            </div>
        </div>
    </div>
